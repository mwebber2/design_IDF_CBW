...
for c in range(len(county_centroids)):
    ...
    for r in range(len(r_master)): #for each RP #NB update this section for other strategies
        ...
        if ((atlas_upper[r] - output_max[0][r])/atlas_upper[r]) >= 0:
            pp1 = 1
        elif ((atlas_upper[r] - output_75[0][r])/atlas_upper[r]) >= 0:
            pp1 = 0.75
        elif diff_45short >= 0:
            pp1 = 0.5
        elif ((atlas_upper[r] - output_25[0][r])/atlas_upper[r]) >= 0:
            pp1 = 0.25
        #else: pp1 = 0
        elif ((atlas_upper[r] - output_min[0][r])/atlas_upper[r]) >= 0:
            pp1 = 0
        else: pp1 = np.nan #-1
        ...
        if ((atlas_upper[r] - output_max[1][r])/atlas_upper[r]) >= 0:
            pp2 = 1
        elif ((atlas_upper[r] - output_75[1][r])/atlas_upper[r]) >= 0:
            pp2 = 0.75
        elif diff_45long >= 0:
            pp2 = 0.5
        elif ((atlas_upper[r] - output_25[1][r])/atlas_upper[r]) >= 0:
            pp2 = 0.25
        #else: pp2 = 0
        elif ((atlas_upper[r] - output_max[1][r])/atlas_upper[r]) >= 0:
            pp2 = 0
        else: pp2 = np.nan #-1
        ...
        if ((atlas_upper[r] - output_max[2][r])/atlas_upper[r]) >= 0:
            pp3 = 1
        elif ((atlas_upper[r] - output_75[2][r])/atlas_upper[r]) >= 0:
            pp3 = 0.75
        elif diff_85short >= 0:
            pp3 = 0.5
        elif ((atlas_upper[r] - output_25[2][r])/atlas_upper[r]) >= 0:
            pp3 = 0.25
        #else: pp2 = 0
        elif ((atlas_upper[r] - output_min[2][r])/atlas_upper[r]) >= 0:
            pp3 = 0
        else: pp3 = np.nan #-1
        ...
        if ((atlas_upper[r] - output_max[3][r])/atlas_upper[r]) >= 0:
            pp4 = 1
        elif ((atlas_upper[r] - output_75[3][r])/atlas_upper[r]) >= 0:
            pp4 = 0.75
        elif diff_85long >= 0:
            pp4 = 0.5
        elif ((atlas_upper[r] - output_25[3][r])/atlas_upper[r]) >= 0:
            pp4 = 0.25
        #else: pp2 = 0
        elif ((atlas_upper[r] - output_min[3][r])/atlas_upper[r]) >= 0:
            pp4 = 0
        else: pp4 = np.nan #-1
...
multiplemaps(diff_allRP_protect_85short, "percentilemap_RCP85_2020-2070.png") #RCP 8.5 2020-2070
multiplemaps(diff_allRP_protect_85long, "percentilemap_RCP85_2050-2100.png") #RCP 8.5 2050-2100
