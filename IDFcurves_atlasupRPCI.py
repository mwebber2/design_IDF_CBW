# -*- coding: utf-8 -*-
"""
Created on Sun May 19 17:32:41 2024
...
for c in range(len(county_centroids)):
    ...
    for r in range(len(r_master)-1): #for each RP -1 because 100yr has no up RP #TODO  
        diff_min = (atlas_upper[r+1] - min(r_master[r]))/atlas_upper[r+1]
        ...
        diff_max = (atlas_upper[r+1] - max(r_master[r]))/atlas_upper[r+1]
        ...
        diff_45short = (atlas_upper[r+1] - r_master[r][0])/atlas_upper[r+1]
        ...
        diff_45long = (atlas_upper[r+1] - r_master[r][1])/atlas_upper[r+1]
        ...
        diff_85short = (atlas_upper[r+1] - r_master[r][2])/atlas_upper[r+1]
        ...
        diff_85long = (atlas_upper[r+1] - r_master[r][3])/atlas_upper[r+1]
